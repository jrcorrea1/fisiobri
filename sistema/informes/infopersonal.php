...
function Header()
{
    ...
    $this->Cell(70,10,'INFORME DE PERSONAL ',0,0,'C');
    // Salto de línea
    $this->Ln(10);
    $this->SetFillColor(2,157,116);
    $this->SetFont('Arial', 'B', 10);
    $this->Cell(10,10,'ID',1,0,'C',1);
    $this->Cell(20,10,'CI/RUC',1,0,'C',1);
	  $this->Cell(40,10,'NOMBRE',1,0,'C',1);
	  $this->Cell(40,10,'APELLIDO',1,0,'C',1);
    $this->Cell(30,10,'FECHA NAC',1,0,'C',1);
    $this->Cell(30,10,'CARGO',1,0,'C',1);
    $this->Cell(25,10,'TELEFONO',1,1,'C',1);
}
...
while ($row=$resultado->fetch_assoc()) {
  $pdf->Cell(10,10,$row['idpersonal'],1,0,'C');
	$pdf->Cell(20,10,$row['dni'],1,0,'C');
  ...
  $pdf->Cell(25,10,$row['telefono'],1,1,'C');
