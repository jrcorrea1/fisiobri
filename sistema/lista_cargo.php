...
<div class="card"style="left: 20px;right: -30;right: 20px;margin-right: 42px;margin-bottom: 20px">
  ...
  <div class="col-sm-2">
    ...
    width: 150px;margin-left: 50px;margin-top: 20px;">
        ...
        <a href="registro_cargo.php" class="btn btn-primary">Nuevo</a>
      </div>
    </div>
  </div>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered" id="table">
					...
					<tbody>
						...
						$query = mysqli_query($conexion, "SELECT * FROM cargo");
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr>
									...
									<?php if ($_SESSION['rol'] == 1) { ?>
									<td>
										<a href="editar_cargo.php?id=<?php echo $data['id']; ?>" class="btn btn-success"><i class='fas fa-edit'></i> Editar</a>
										<form action="eliminar_cargo.php?id=<?php echo $data['id']; ?>" method="post" class="confirmar d-inline">
