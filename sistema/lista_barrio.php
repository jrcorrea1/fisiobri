...
<div class="card" style="    left: 20px;
    ...
    margin-bottom: 20px">
  <div class="card-body">
    <div align="center"><h4>Mantenimiento de Barrio</h4></div>
  </div>
</div>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered" id="table">
					...
					<tbody>
						...
						$query = mysqli_query($conexion, "SELECT * FROM barrio");
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr>
									...
									<?php if ($_SESSION['rol'] == 1) { ?>
									<td>
										<a href="editar_barrio.php?id=<?php echo $data['id']; ?>" class="btn btn-success"><i class='fas fa-edit'></i> Editar</a>
										<form action="eliminar_barrio.php?id=<?php echo $data['id']; ?>" method="post" class="confirmar d-inline">
