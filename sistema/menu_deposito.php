...
<img src="img/fisio2.png" class="card-img-top" alt="..." style="width: 150px;margin-left: 50px;margin-top: 16px;
">
      <div class="card-body">
  ...
  <div class="col-sm-2">
    <div class="card" style="width: 18rem;left: 80px;">
    <img src="img/fisio.png" class="card-img-top" alt="..." style="width: 150px;margin-left: 50px;margin-top: 11px;">
          <div class="card-body">
