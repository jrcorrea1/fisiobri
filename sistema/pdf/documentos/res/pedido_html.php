...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
		<tr>
			<td class='pumpkin' style="width:45%; ">PROVEEDOR DESIGNADO</td>
			<td  style="width:10%; "></td>
			<td class='pumpkin' style="width:45%; ">REMITIR PEDIDOS A:</td>
		</tr>
		<tr>
			<td style="width:45%; ">
	...
	<table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
		<tr>
			<td class='pumpkin' style="width:33%; ">VIA DE TRANSPORTE</td>
			<td class='pumpkin' style="width:34%; ">FORMAS DE PAGO</td>
